# Goint
MovieApp
**FlicksMovieApp** shows the latest movies currently playing in twitters. The app utilizes the Movie Database API to display images and basic information about these movies to the user.
...
There are too many codes for a simple App.
